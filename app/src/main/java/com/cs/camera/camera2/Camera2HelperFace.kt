...
/*
     ...
     * 监听点击事件
     */
    private fun viewClickManager() : Handler.Callback {

        val INTERVAL = 300//双击间隔时间 毫秒
        val WHAT_CLICK = 1000

        //save the clickable view，and last click time fo views
        val mViews = HashMap<Int, ArrayList<ViewClickManager.OnClickListener>>()
        val mHandle = Handler(this)
        ...
        fun setClickLister(view: View?, lister: ViewClickManager.OnClickListener?) {
            ...
            view.setOnClickListener {
                val tempList: ArrayList<ViewClickManager.OnClickListener>
